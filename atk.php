    ...
    <div>
        <div style="float:left;">
            <table>
                ...
                $sql = "SELECT Location.LID, Location.Name, Location.Address, Contact.Contact FROM Location
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr><td>". "<a href = \"postCollection.php?lid=".$row["LID"]."\">".$row["Name"]."</a>"."</td><td>". $row["Address"]."</td><td>". $row["Contact"]."</td><tr>";
                    }
                    echo "</table>";
                }
                else {
