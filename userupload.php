...
<html>
    ...
    <body>
        ...
        if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] === true) {
            ...
            "<nav class='nav justify-content-center'><a class='nav-link active' href='/304project/userupload.php'>Uploads</a>" . 
            " / " . "<a class='nav-link secondary' href='/304project/userfav.php'>Favorites</a></nav>"; 
            echo "<br>";
